...
####
    ...
    switch_info = fos_gen_tc_0.capture_switch_info("compare_orig", fid_to_compare)
    #    
    ...
    ####
    ####   usage for reboot_reconnect(ipaddress, username, password, reboot-TRUE FALSE, no of times)
    
    tn = cofra.reboot_reconnect(pa.ipaddr, user_name, usr_psswd, 1, 1)
    ...
    if steps_to_run == 2 or steps_to_run == 3:
        ...
        switch_info = fos_gen_tc_0.capture_switch_info("compare", fid_to_compare)
    ###################################################################################################################
