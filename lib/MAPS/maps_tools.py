...
def maps_default_rule():
    ...
    l = "defNON_E_F_PORTSCRC_0	|RASLOG,SNMP,EMAIL	|NON_E_F_PORTS(CRC/MIN>0)	,\
        ...
        defALL_25Km_16GLWL_SFPTXP_4466	ALL_25Km_16GLWL_SFP(RXP/NONE>=4466)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        ...
        defALL_CIRCUIT_MED_QOS_PKTLOSS_PER_5	ALL_CIRCUIT_MED_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
