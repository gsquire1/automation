...
def maps_default_rule():
    ...
    l = "defNON_E_F_PORTSCRC_0	|RASLOG,SNMP,EMAIL	|NON_E_F_PORTS(CRC/MIN>0)	,\
        ...
        defALL_25Km_16GLWL_SFPCURRENT_90        |ALL_25Km_16GLWL_SFP(CURRENT/NONE>=90)             |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPRXP_2238          |ALL_25Km_16GLWL_SFP(RXP/NONE>=2238)               |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPSFP_TEMP_75       |ALL_25Km_16GLWL_SFP(SFP_TEMP/NONE>=75)            |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPSFP_TEMP_n5       |ALL_25Km_16GLWL_SFP(SFP_TEMP/NONE<=-5)            |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPTXP_4466          |ALL_25Km_16GLWL_SFP(TXP/NONE>=4466)               |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPVOLTAGE_2850      |ALL_25Km_16GLWL_SFP(VOLTAGE/NONE<=2850)           |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_25Km_16GLWL_SFPVOLTAGE_3750      |ALL_25Km_16GLWL_SFP(VOLTAGE/NONE>=3750)           |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPCURRENT_60             |ALL_32GLWL_SFP(CURRENT/NONE>=60)                  |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPRXP_1995               |ALL_32GLWL_SFP(RXP/NONE>=1995)                    |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPSFP_TEMP_75            |ALL_32GLWL_SFP(SFP_TEMP/NONE>=75)                 |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPSFP_TEMP_n5            |ALL_32GLWL_SFP(SFP_TEMP/NONE<=-5)                 |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPTXP_1584               |ALL_32GLWL_SFP(TXP/NONE>=1584)                    |SFP_MARGINAL,RASLOG,SNMP,EM      .\
        defALL_32GLWL_SFPVOLTAGE_3000           |ALL_32GLWL_SFP(VOLTAGE/NONE<=3000)                |SFP_MARGINAL,RASLOG,SNMP,EM
        defALL_32GLWL_SFPVOLTAGE_3600           |ALL_32GLWL_SFP(VOLTAGE/NONE>=3600)                |SFP_MARGINAL,RASLOG,SNMP,EM
        ...
        defALL_32GLWL_SFPVOLTAGE_3000	ALL_32GLWL_SFP(VOLTAGE/NONE<=3000)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GLWL_SFPVOLTAGE_3600	ALL_32GLWL_SFP(VOLTAGE/NONE>=3600)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPCURRENT_10	ALL_32GSWL_QSFP(CURRENT/NONE>=10)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPRXP_3400	ALL_32GSWL_QSFP(RXP/NONE>=3400)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPSFP_TEMP_75	ALL_32GSWL_QSFP(SFP_TEMP/NONE>=75)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPSFP_TEMP_n5	ALL_32GSWL_QSFP(SFP_TEMP/NONE<=-5)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPVOLTAGE_2970	ALL_32GSWL_QSFP(VOLTAGE/NONE<=2970)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_QSFPVOLTAGE_3630	ALL_32GSWL_QSFP(VOLTAGE/NONE>=3630)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPCURRENT_12	ALL_32GSWL_SFP(CURRENT/NONE>=12)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPRXP_1259	ALL_32GSWL_SFP(RXP/NONE>=1259)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPSFP_TEMP_85	ALL_32GSWL_SFP(SFP_TEMP/NONE>=85)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPSFP_TEMP_n5	ALL_32GSWL_SFP(SFP_TEMP/NONE<=-5)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPTXP_1259	ALL_32GSWL_SFP(TXP/NONE>=1259)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPVOLTAGE_3000	ALL_32GSWL_SFP(VOLTAGE/NONE<=3000)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_32GSWL_SFPVOLTAGE_3600	ALL_32GSWL_SFP(VOLTAGE/NONE>=3600)	SFP_MARGINAL,RASLOG,SNMP,EM      ,\
        defALL_CIRCUIT_IP_MED_QOS_PKTLOSS_P_05	ALL_CIRCUIT_IP_MED_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_IP_MED_QOS_PKTLOSS_P_1	ALL_CIRCUIT_IP_MED_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_IP_MED_QOS_PKTLOSS_P_5	ALL_CIRCUIT_IP_MED_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_IP_MED_QOS_UTIL_P_50	ALL_CIRCUIT_IP_MED_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_IP_MED_QOS_UTIL_P_75	ALL_CIRCUIT_IP_MED_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_IP_MED_QOS_UTIL_P_90	ALL_CIRCUIT_IP_MED_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_PKTLOSS_PER_05	ALL_CIRCUIT_LOW_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_PKTLOSS_PER_1	ALL_CIRCUIT_LOW_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_PKTLOSS_PER_5	ALL_CIRCUIT_LOW_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_UTIL_PER_50	ALL_CIRCUIT_LOW_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_UTIL_PER_75	ALL_CIRCUIT_LOW_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_LOW_QOS_UTIL_PER_90	ALL_CIRCUIT_LOW_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_PKTLOSS_PER_05	ALL_CIRCUIT_MED_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_PKTLOSS_PER_1	ALL_CIRCUIT_MED_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_PKTLOSS_PER_5maps_default_rule	ALL_CIRCUIT_MED_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_UTIL_PER_50	ALL_CIRCUIT_MED_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_UTIL_PER_75	ALL_CIRCUIT_MED_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUIT_MED_QOS_UTIL_PER_90	ALL_CIRCUIT_MED_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_JITTER_PER_05	ALL_CIRCUITS(IP_JITTER/NONE>5)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_JITTER_PER_15	ALL_CIRCUITS(IP_JITTER/NONE>15)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_JITTER_PER_20	ALL_CIRCUITS(IP_JITTER/NONE>20)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_PKTLOSS_P_05	ALL_CIRCUITS(IP_PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_PKTLOSS_P_1	ALL_CIRCUITS(IP_PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_PKTLOSS_P_5	ALL_CIRCUITS(IP_PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_RTT_250	ALL_CIRCUITS(IP_RTT/NONE>250)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_UTIL_P_60	ALL_CIRCUITS(IP_UTIL/MIN>60)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_UTIL_P_75	ALL_CIRCUITS(IP_UTIL/MIN>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_CIRCUITS_IP_UTIL_P_90	ALL_CIRCUITS(IP_UTIL/MIN>90)	RASLOG,SNMP,EMAIL      ,\
        ...
        defALL_EXT_GE_PORTSINV_LEN_10	ALL_EXT_GE_PORTS(GE_INV_LEN/MIN>10)	RASLOG,SNMP,EMAIL      ,\
        defALL_EXT_GE_PORTSINV_LEN_20	ALL_EXT_GE_PORTS(GE_INV_LEN/MIN>20)	RASLOG,SNMP,EMAIL      ,\
        defALL_EXT_GE_PORTSINV_LEN_5	ALL_EXT_GE_PORTS(GE_INV_LEN/MIN>5)	RASLOG,SNMP,EMAIL      ,\
        defALL_EXT_GE_PORTSLOS_10	ALL_EXT_GE_PORTS(GE_LOS_OF_SIG/MIN>10)	RASLOG,SNMP,EMAIL      ,\
        defALL_EXT_GE_PORTSLOS_20	ALL_EXT_GE_PORTS(GE_LOS_OF_SIG/MIN>20)	RASLOG,SNMP,EMAIL      ,\
        defALL_EXT_GE_PORTSLOS_5	ALL_EXT_GE_PORTS(GE_LOS_OF_SIG/MIN>5)	RASLOG,SNMP,EMAIL      ,\
        defALL_FAN_AIR_FLOW_MISMATCH	CHASSIS(FAN_AIRFLOW_MISMATCH/NONE==TRUE)	SNMP,EMAIL,SW_MARGINAL      ,\
        defALL_LOCAL_PIDSIT_FLOW_16	ALL_LOCAL_PIDS(IT_FLOW/NONE>16)	RASLOG,SNMP,EMAIL      ,\
        defALL_LOCAL_PIDSIT_FLOW_32	ALL_LOCAL_PIDS(IT_FLOW/NONE>32)	RASLOG,SNMP,EMAIL      ,\
        defALL_LOCAL_PIDSIT_FLOW_8	ALL_LOCAL_PIDS(IT_FLOW/NONE>8)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLF_0	ALL_PORTS(LF/MIN>0)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLF_3	ALL_PORTS(LF/MIN>3)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLF_5	ALL_PORTS(LF/MIN>5)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLOSS_SIGNAL_0	ALL_PORTS(LOSS_SIGNAL/MIN>0)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLOSS_SIGNAL_3	ALL_PORTS(LOSS_SIGNAL/MIN>3)	RASLOG,SNMP,EMAIL      ,\
        defALL_PORTSLOSS_SIGNAL_5	ALL_PORTS(LOSS_SIGNAL/MIN>5)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_PKTLOSS_P_05	ALL_TUNNEL_IP_HIGH_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_PKTLOSS_P_1	ALL_TUNNEL_IP_HIGH_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_PKTLOSS_P_5	ALL_TUNNEL_IP_HIGH_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_UTIL_P_50	ALL_TUNNEL_IP_HIGH_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_UTIL_P_75	ALL_TUNNEL_IP_HIGH_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_HIGH_QOS_UTIL_P_90	ALL_TUNNEL_IP_HIGH_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_PKTLOSS_P_05	ALL_TUNNEL_IP_LOW_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_PKTLOSS_P_1	ALL_TUNNEL_IP_LOW_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_PKTLOSS_P_5	ALL_TUNNEL_IP_LOW_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_UTIL_P_50	ALL_TUNNEL_IP_LOW_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_UTIL_P_75	ALL_TUNNEL_IP_LOW_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_LOW_QOS_UTIL_P_90	ALL_TUNNEL_IP_LOW_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_PKTLOSS_P_05	ALL_TUNNEL_IP_MED_QOS(PKTLOSS/MIN>0.05)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_PKTLOSS_P_1	ALL_TUNNEL_IP_MED_QOS(PKTLOSS/MIN>0.1)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_PKTLOSS_P_5	ALL_TUNNEL_IP_MED_QOS(PKTLOSS/MIN>0.5)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_UTIL_P_50	ALL_TUNNEL_IP_MED_QOS(UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_UTIL_P_75	ALL_TUNNEL_IP_MED_QOS(UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNEL_IP_MED_QOS_UTIL_P_90	ALL_TUNNEL_IP_MED_QOS(UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNELS_IP_UTIL_P_50	ALL_TUNNELS(IP_UTIL/HOUR>50)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNELS_IP_UTIL_P_75	ALL_TUNNELS(IP_UTIL/HOUR>75)	RASLOG,SNMP,EMAIL      ,\
        defALL_TUNNELS_IP_UTIL_P_90	ALL_TUNNELS(IP_UTIL/HOUR>90)	RASLOG,SNMP,EMAIL      ,\
        defCHASSISCERT_VALIDITY_15	ALL_CERTS(DAYS_TO_EXPIRE/NONE<15)	RASLOG,SNMP,EMAIL      ,\
        defCHASSISCERT_VALIDITY_20	ALL_CERTS(DAYS_TO_EXPIRE/NONE<20)	RASLOG,SNMP,EMAIL      ,\
        defCHASSISCERT_VALIDITY_30	ALL_CERTS(DAYS_TO_EXPIRE/NONE<30)	RASLOG,SNMP,EMAIL      ,\
        defCHASSISCERTS_EXPIRED	CHASSIS(EXPIRED_CERTS/NONE>0)	RASLOG,SW_MARGINAL      ,\
        | ,\
    "
