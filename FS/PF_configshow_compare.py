...
def parent_parser():
    ...
    # pp.add_argument('-e', '--email', type=str, default=0, help="email address")
...
def parse_args():
    ...
    # parser.add_argument('-e', '--email', type=str, default=0, help="email address")
...
def main():
    ...
    # f1 = "%s%s%s%s" % ("logs/Configupload_test_case_file_TheEND", "_" + ipaddr_switch + "_", date_is, ".txt")
    ...
    # print("Result ")
    # print(diff_f)
    # liabhar.email_sender_html(pa.email, pa.email, "portflapper passed", "portflapper passed",
    #                           "")
    #
    # return True
