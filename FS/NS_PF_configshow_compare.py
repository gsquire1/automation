    ...
    if not nos:
        ...
        for i in range(h):
            ...
            if fabric_check != fabric_check1:
                ...
                liabhar.email_sender_html("gsquire@brocade.com","gsquire@brocade.com","NS_portflapper failed becasue of Fabric Check","NS_portflapper failed because of Fabric Check","")
                anturlar.close_tel()
                sys.exit()
        ...
        print("\n"+"@"*40)
        liabhar.email_sender_html("gsquire@brocade.com","gsquire@brocade.com","NS_portflapper failed becasue of NOS Check","NS_portflapper failed because of NOS Check","")
        sys.exit()
    anturlar.close_tel()
    print("#"*80)
    print("#"*80)
