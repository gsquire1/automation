...
package Raritan::RPC::net::Net;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "net.Net:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::net::Net::typeId;
...
sub getNetworkConfigInterface($$$$$) {
    ...
    $$state = Raritan::RPC::net::InterfaceState::decode($agent, $rsp->{'state'});
    $$lan = Raritan::RPC::net::LanInterfaceSettings::decode($agent, $rsp->{'lan'});
    $$lancurrent = Raritan::RPC::net::LanInterfaceParameters::decode($agent, $rsp->{'lancurrent'});
...
Raritan::RPC::Registry::registerProxyClass('net.Net', 1, 0, 0, 'Raritan::RPC::net::Net');
1;
