...
package Raritan::RPC::net::Net_2_0_1;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "net.Net:2.0.1";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::net::Net_2_0_1::typeId;
...
Raritan::RPC::Registry::registerProxyClass('net.Net', 2, 0, 1, 'Raritan::RPC::net::Net_2_0_1');
1;
