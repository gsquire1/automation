...
package Raritan::RPC::net::Net_3_0_0;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "net.Net:3.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::net::Net_3_0_0::typeId;
...
sub getNetworkConfigInterface($$$$$) {
    ...
    $$wlan = Raritan::RPC::net::WirelessInterfaceSettings_2_0_0::decode($agent, $rsp->{'wlan'});
}
...
sub setNetworkConfigWLan($$) {
    ...
    my $agent = $self->{'agent'};
    my $args = {};
    $args->{'wlancfg'} = Raritan::RPC::net::WirelessInterfaceSettings_2_0_0::encode($wlancfg);
...
Raritan::RPC::Registry::registerProxyClass('net.Net', 3, 0, 0, 'Raritan::RPC::net::Net_3_0_0');
1;
