...
package Raritan::RPC::peripheral::DeviceManager_2_0_0::DeviceTypeInfo;
...
sub encode {
    ...
    $encoded->{'defaultRange'} = Raritan::RPC::sensors::NumericSensor_4_0_0::Range::encode($in->{'defaultRange'});
...
sub decode {
    ...
    $decoded->{'defaultRange'} = Raritan::RPC::sensors::NumericSensor_4_0_0::Range::decode($agent, $in->{'defaultRange'});
