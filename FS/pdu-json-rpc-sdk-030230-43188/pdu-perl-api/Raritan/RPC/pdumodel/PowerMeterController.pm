...
package Raritan::RPC::pdumodel::PowerMeterController;

use parent qw(Raritan::RPC::RemoteObject);

use constant typeId => "pdumodel.PowerMeterController:1.0.0";

sub new {
    my ($class, $agent, $rid, $typeId) = @_;
    $typeId = $typeId || Raritan::RPC::pdumodel::PowerMeterController::typeId;
...
sub scanMeterBoard($$$) {
    ...
    $$result = Raritan::RPC::pdumodel::PowerMeterController::ScanResult::decode($agent, $rsp->{'result'});
    my $_ret_;
    $_ret_ = $rsp->{'_ret_'};
    return $_ret_;
}
...
Raritan::RPC::Registry::registerProxyClass('pdumodel.PowerMeterController', 1, 0, 0, 'Raritan::RPC::pdumodel::PowerMeterController');
1;
