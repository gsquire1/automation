...
package Raritan::RPC::pdumodel::Pdu_4_0_0::Statistic;
...
sub encode {
    ...
    $encoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_2_0_2::Statistics::encode($in->{'peripheralStats'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_2_0_2::Statistics::decode($agent, $in->{'peripheralStats'});
    return $decoded;
}
