...
package Raritan::RPC::pdumodel::PowerMeterController::PowerMeterCreatedEvent;

use constant typeId => "pdumodel.PowerMeterController.PowerMeterCreatedEvent:1.0.0";
...
Raritan::RPC::Registry::registerCodecClass('pdumodel.PowerMeterController.PowerMeterCreatedEvent', 1, 0, 0, 'Raritan::RPC::pdumodel::PowerMeterController::PowerMeterCreatedEvent');
1;
