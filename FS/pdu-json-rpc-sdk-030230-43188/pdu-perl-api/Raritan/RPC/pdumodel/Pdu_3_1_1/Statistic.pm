...
package Raritan::RPC::pdumodel::Pdu_3_1_1::Statistic;
...
sub encode {
    ...
    $encoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_2_0_1::Statistics::encode($in->{'peripheralStats'});
    return $encoded;
}
...
sub decode {
    ...
    $decoded->{'peripheralStats'} = Raritan::RPC::peripheral::DeviceManager_2_0_1::Statistics::decode($agent, $in->{'peripheralStats'});
    return $decoded;
}
