...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/webcam/idl/Webcam.idl"
#
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/webcam/idl/WebcamChannel.idl"
#
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/webcam/idl/WebcamManager.idl"
#
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/webcam/idl/StorageManager.idl"
#
...
class StorageManager(Interface):
    ...
    class StorageType(Enumeration):
        idlType = "webcam.StorageManager_1_0_1.StorageType:1.0.0"
    ...
    class Direction(Enumeration):
        idlType = "webcam.StorageManager_1_0_1.Direction:1.0.0"
    ...
    class StorageStatus(Enumeration):
        idlType = "webcam.StorageManager_1_0_1.StorageStatus:1.0.0"
    ...
    class WebcamStorageInfo(Structure):
        idlType = "webcam.StorageManager_1_0_1.WebcamStorageInfo:1.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                webcam = Interface.decode(json['webcam'], agent),
                newestIndex = long(json['newestIndex']),
                oldestIndex = long(json['oldestIndex']),
                count = json['count'],
            )
            return obj
    ...
    class StorageInformation(Structure):
        idlType = "webcam.StorageManager_1_0_1.StorageInformation:1.0.0"
    ...
    class StorageSettings(Structure):
        idlType = "webcam.StorageManager_1_0_1.StorageSettings:1.0.0"
    ...
    class StorageMetaData(Structure):
        idlType = "webcam.StorageManager_1_0_1.StorageMetaData:1.0.0"
    ...
    class ImageStorageMetaData(Structure):
        idlType = "webcam.StorageManager_1_0_1.ImageStorageMetaData:1.0.0"
    ...
    class StorageImage(Structure):
        idlType = "webcam.StorageManager_1_0_1.StorageImage:1.0.0"
    ...
    class Activity(Structure):
        idlType = "webcam.StorageManager_1_0_1.Activity:1.0.0"
