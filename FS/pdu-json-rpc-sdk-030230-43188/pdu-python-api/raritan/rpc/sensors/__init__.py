...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensors/idl/Sensor.idl"
#
...
class Sensor(Interface):
    ...
    class OnOffState(Enumeration):
        idlType = "sensors.Sensor_4_0_1.OnOffState:1.0.0"
        values = ["OFF", "ON"]
    ...
    class TypeSpec(Structure):
        idlType = "sensors.Sensor_4_0_1.TypeSpec:1.0.0"
    ...
    class TypeSpecChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.Sensor_4_0_1.TypeSpecChangedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensors/idl/NumericSensor.idl"
#
...
class NumericSensor(Sensor):
    idlType = "sensors.NumericSensor:4.0.1"
    ...
    class Range(Structure):
        idlType = "sensors.NumericSensor_4_0_1.Range:1.0.0"
    ...
    class ThresholdCapabilities(Structure):
        idlType = "sensors.NumericSensor_4_0_1.ThresholdCapabilities:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "sensors.NumericSensor_4_0_1.MetaData:1.0.0"
    ...
    class Thresholds(Structure):
        idlType = "sensors.NumericSensor_4_0_1.Thresholds:1.0.0"
    ...
    class Reading(Structure):
        idlType = "sensors.NumericSensor_4_0_1.Reading:1.0.0"
        ...
        class Status(Structure):
            idlType = "sensors.NumericSensor_4_0_1.Reading.Status:1.0.0"
    ...
    class ReadingChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_1.ReadingChangedEvent:1.0.0"
    ...
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_1.StateChangedEvent:1.0.0"
    ...
    class MetaDataChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.NumericSensor_4_0_1.MetaDataChangedEvent:1.0.0"
    ...
    class ThresholdsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.NumericSensor_4_0_1.ThresholdsChangedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensorlogger/idl/SensorLogger.idl"
#
...
class Logger(Interface):
    idlType = "sensors.Logger:2.1.4"

    # structure
    class Settings(Structure):
        idlType = "sensors.Logger_2_1_4.Settings:1.0.0"
    ...
    class SensorSet(Structure):
        idlType = "sensors.Logger_2_1_4.SensorSet:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_1_4.SettingsChangedEvent:1.0.0"
    ...
    class LoggedSensorsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.Logger_2_1_4.LoggedSensorsChangedEvent:1.0.0"
    ...
    class Record(Structure):
        idlType = "sensors.Logger_2_1_4.Record:1.0.0"
    ...
    class TimedRecord(Structure):
        idlType = "sensors.Logger_2_1_4.TimedRecord:1.0.0"
    ...
    class LogRow(Structure):
        idlType = "sensors.Logger_2_1_4.LogRow:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensors/idl/StateSensor.idl"
#
...
class StateSensor(Sensor):
    idlType = "sensors.StateSensor:4.0.1"

    # structure
    class State(Structure):
        idlType = "sensors.StateSensor_4_0_1.State:1.0.0"
    ...
    # value object
    class StateChangedEvent(raritan.rpc.idl.Event):
        idlType = "sensors.StateSensor_4_0_1.StateChangedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensors/idl/AccumulatingNumericSensor.idl"
#
...
class AccumulatingNumericSensor(NumericSensor):
    idlType = "sensors.AccumulatingNumericSensor:2.0.1"

    # value object
    class ResetEvent(raritan.rpc.event.UserEvent):
        idlType = "sensors.AccumulatingNumericSensor_2_0_1.ResetEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/sensors/idl/Switch.idl"
#
