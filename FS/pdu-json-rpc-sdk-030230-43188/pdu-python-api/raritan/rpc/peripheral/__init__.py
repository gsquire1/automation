...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/peripheral/idl/PeripheralDeviceSlot.idl"
#
...
class DeviceSlot(Interface):
    ...
    class Location(Structure):
        idlType = "peripheral.DeviceSlot_2_0_1.Location:1.0.0"
        elements = ["x", "y", "z"]
    ...
    class Settings(Structure):
        idlType = "peripheral.DeviceSlot_2_0_1.Settings:1.0.0"
    ...
    class DeviceChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceSlot_2_0_1.DeviceChangedEvent:1.0.0"
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceSlot_2_0_1.SettingsChangedEvent:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/peripheral/idl/PeripheralDevicePackage.idl"
#
...
class PackageInfo(Structure):
    ...
    class State(Enumeration):
        idlType = "peripheral.PackageInfo_2_0_0.State:1.0.0"
    ...
    class HardwareInfo(Structure):
        idlType = "peripheral.PackageInfo_2_0_0.HardwareInfo:1.0.0"
    ...
    class FirmwareInfo(Structure):
        idlType = "peripheral.PackageInfo_2_0_0.FirmwareInfo:1.0.0"
        ...
        class Version(Structure):
            idlType = "peripheral.PackageInfo_2_0_0.FirmwareInfo.Version:1.0.0"
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/peripheral/idl/PeripheralDeviceManager.idl"
#
...
class DeviceManager(Interface):
    idlType = "peripheral.DeviceManager:2.0.2"

    ERR_INVALID_PARAMS = 1

    # enumeration
    class ZCoordMode(Enumeration):
        idlType = "peripheral.DeviceManager_2_0_2.ZCoordMode:1.0.0"
    ...
    # structure
    class Settings(Structure):
        idlType = "peripheral.DeviceManager_2_0_2.Settings:1.0.0"
    ...
    class MetaData(Structure):
        idlType = "peripheral.DeviceManager_2_0_2.MetaData:1.0.0"
    ...
    class DeviceTypeInfo(Structure):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceTypeInfo:1.0.0"
    ...
    class FirmwareUpdateState(Structure):
        idlType = "peripheral.DeviceManager_2_0_2.FirmwareUpdateState:1.0.0"
    ...
    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "peripheral.DeviceManager_2_0_2.SettingsChangedEvent:1.0.0"
    ...
    class DeviceEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceEvent:2.0.0"
    ...
    class DeviceAddedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_2_0_2.DeviceEvent_2_0_0
                devices = [ValueObject.decode(x0, agent) for x0 in json['devices']],
                allDevices = [ValueObject.decode(x0, agent) for x0 in json['allDevices']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class DeviceRemovedEvent(DeviceEvent):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceRemovedEvent:2.0.0"
    ...
    class UnknownDeviceAttachedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_2_0_2.UnknownDeviceAttachedEvent:1.0.0"
    ...
    class DeviceFirmwareUpdateState(Enumeration):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceFirmwareUpdateState:1.0.0"
    ...
    class DeviceFirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_2_0_2.DeviceFirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class FirmwareUpdateStateChangedEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_2_0_2.FirmwareUpdateStateChangedEvent:1.0.0"
    ...
    class PackageEvent(raritan.rpc.idl.Event):
        idlType = "peripheral.DeviceManager_2_0_2.PackageEvent:2.0.0"
    ...
    class PackageAddedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_2_0_2.PackageAddedEvent:2.0.0"
        ...
        def decode(cls, json, agent):
            obj = cls(
                # for peripheral.DeviceManager_2_0_2.PackageEvent_2_0_0
                packageInfos = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['packageInfos']],
                allPackages = [raritan.rpc.peripheral.PackageInfo.decode(x0, agent) for x0 in json['allPackages']],
                # for idl.Event
                source = Interface.decode(json['source'], agent),
    ...
    class PackageRemovedEvent(PackageEvent):
        idlType = "peripheral.DeviceManager_2_0_2.PackageRemovedEvent:2.0.0"
    ...
    class Statistics(Structure):
        idlType = "peripheral.DeviceManager_2_0_2.Statistics:1.0.0"
        elements = ["cSumErrCnt"]
...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/peripheral/idl/PeripheralG2Production.idl"
#
...
class G2Production(Interface):
    ...
    # structure
    class FirmwareInfo(Structure):
        idlType = "peripheral.G2Production_2_0_0.FirmwareInfo:1.0.0"
    ...
    class _updateFirmware(Interface.Method):
        name = 'updateFirmware'
    ...
    class _updateFirmwarePos(Interface.Method):
        name = 'updateFirmwarePos'
    ...
    class _getFirmwareInfo(Interface.Method):
    ...
    class _getFirmwareInfoPos(Interface.Method):
        name = 'getFirmwareInfoPos'
    ...
    class ConfigurationSpace(Enumeration):
        idlType = "peripheral.G2Production_2_0_0.ConfigurationSpace:1.0.0"
    ...
    class _readConfigurationSpace(Interface.Method):
        name = 'readConfigurationSpace'

        @staticmethod
        def encode(romcode, cs):
            typecheck.is_string(romcode, AssertionError)
    ...
    class _readConfigurationSpacePos(Interface.Method):
        name = 'readConfigurationSpacePos'

        @staticmethod
        def encode(position, cs):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_enum(cs, raritan.rpc.peripheral.G2Production.ConfigurationSpace, AssertionError)
            args = {}
    ...
    class _eraseConfigurationSpace(Interface.Method):
        name = 'eraseConfigurationSpace'
    ...
    class _eraseConfigurationSpacePos(Interface.Method):
        name = 'eraseConfigurationSpacePos'
    ...
    class _writeConfigurationSpace(Interface.Method):
        name = 'writeConfigurationSpace'

        @staticmethod
        def encode(romcode, cs, cfg):
            typecheck.is_string(romcode, AssertionError)
            typecheck.is_enum(cs, raritan.rpc.peripheral.G2Production.ConfigurationSpace, AssertionError)
            for x0 in cfg:
    ...
    class _writeConfigurationSpacePos(Interface.Method):
        name = 'writeConfigurationSpacePos'

        @staticmethod
        def encode(position, cs, cfg):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_enum(cs, raritan.rpc.peripheral.G2Production.ConfigurationSpace, AssertionError)
            for x0 in cfg:
    ...
    class _readRegisters(Interface.Method):
        name = 'readRegisters'

        @staticmethod
        def encode(romcode, address, count):
            typecheck.is_string(romcode, AssertionError)
    ...
    class _readRegistersPos(Interface.Method):
        name = 'readRegistersPos'

        @staticmethod
        def encode(position, address, count):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_int(address, AssertionError)
            typecheck.is_int(count, AssertionError)
    ...
    class _writeRegisters(Interface.Method):
        name = 'writeRegisters'

        @staticmethod
        def encode(romcode, address, data):
            typecheck.is_string(romcode, AssertionError)
            typecheck.is_int(address, AssertionError)
            for x0 in data:
                typecheck.is_byte(x0, AssertionError)
    ...
    class _writeRegistersPos(Interface.Method):
        name = 'writeRegistersPos'

        @staticmethod
        def encode(position, address, data):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_int(address, AssertionError)
            for x0 in data:
    ...
    class _writeRegisterBits(Interface.Method):
        name = 'writeRegisterBits'

        @staticmethod
        def encode(romcode, address, mask, bits):
            typecheck.is_string(romcode, AssertionError)
            typecheck.is_int(address, AssertionError)
    ...
    class _writeRegisterBitsPos(Interface.Method):
        name = 'writeRegisterBitsPos'

        @staticmethod
        def encode(position, address, mask, bits):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_int(address, AssertionError)
            typecheck.is_byte(mask, AssertionError)
    ...
    class ResetMethod(Enumeration):
        idlType = "peripheral.G2Production_2_0_0.ResetMethod:1.0.0"
    ...
    class _resetPos(Interface.Method):
        name = 'resetPos'

        @staticmethod
        def encode(position, method):
            for x0 in position:
                typecheck.is_struct(x0, raritan.rpc.peripheral.PosElement, AssertionError)
            typecheck.is_enum(method, raritan.rpc.peripheral.G2Production.ResetMethod, AssertionError)
            args = {}
    ...
    def __init__(self, target, agent):
        ...
        self.updateFirmware = G2Production._updateFirmware(self)
        self.updateFirmwarePos = G2Production._updateFirmwarePos(self)
        self.getFirmwareInfo = G2Production._getFirmwareInfo(self)
        self.getFirmwareInfoPos = G2Production._getFirmwareInfoPos(self)
        self.readConfigurationSpace = G2Production._readConfigurationSpace(self)
        self.readConfigurationSpacePos = G2Production._readConfigurationSpacePos(self)
        self.eraseConfigurationSpace = G2Production._eraseConfigurationSpace(self)
        self.eraseConfigurationSpacePos = G2Production._eraseConfigurationSpacePos(self)
        self.writeConfigurationSpace = G2Production._writeConfigurationSpace(self)
        self.writeConfigurationSpacePos = G2Production._writeConfigurationSpacePos(self)
        self.readRegisters = G2Production._readRegisters(self)
        self.readRegistersPos = G2Production._readRegistersPos(self)
        self.writeRegisters = G2Production._writeRegisters(self)
        self.writeRegistersPos = G2Production._writeRegistersPos(self)
        self.writeRegisterBits = G2Production._writeRegisterBits(self)
        self.writeRegisterBitsPos = G2Production._writeRegisterBitsPos(self)
        self.reset = G2Production._reset(self)
        self.resetPos = G2Production._resetPos(self)
