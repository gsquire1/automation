...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/servermon/idl/ServerMonitor.idl"
#
...
class ServerMonitor(Interface):
    ...
    class ServerReachability(Enumeration):
        idlType = "servermon.ServerMonitor_2_0_0.ServerReachability:1.0.0"
    ...
    class ServerSettings(Structure):
        idlType = "servermon.ServerMonitor_2_0_0.ServerSettings:1.0.0"
    ...
    class ServerStatus(Structure):
        idlType = "servermon.ServerMonitor_2_0_0.ServerStatus:1.0.0"
    ...
    class Server(Structure):
        idlType = "servermon.ServerMonitor_2_0_0.Server:1.0.0"
