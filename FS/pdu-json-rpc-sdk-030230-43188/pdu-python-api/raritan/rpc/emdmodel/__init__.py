...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/emd/idl/Emd.idl"
#
...
# interface
class Emd(Interface):
    idlType = "emdmodel.Emd:2.1.4"

    ERR_INVALID_PARAMS = 1

    # structure
    class MetaData(Structure):
        idlType = "emdmodel.Emd_2_1_4.MetaData:1.0.0"
    ...
    class Settings(Structure):
        idlType = "emdmodel.Emd_2_1_4.Settings:1.0.0"
        elements = ["name"]
    ...
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "emdmodel.Emd_2_1_4.SettingsChangedEvent:1.0.0"
