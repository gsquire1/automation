...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/luaserviced/client/idl/LuaService.idl"
#
...
class ScriptOptions(Structure):
    idlType = "luaservice.ScriptOptions:1.0.0"
    elements = ["autoStart", "autoRestart"]

    def __init__(self, autoStart, autoRestart):
...
class Environment(Structure):
    idlType = "luaservice.Environment:1.0.0"
    elements = ["maxMemoryPerScript", "maxAmountOfScripts", "amountOfScripts", "maxScriptSize", "maxAllScriptSize", "allScriptSize", "outputBufferSize", "restartInterval", "autoStartDelay"]

    def __init__(self, maxMemoryPerScript, maxAmountOfScripts, amountOfScripts, maxScriptSize, maxAllScriptSize, allScriptSize, outputBufferSize, restartInterval, autoStartDelay):
        typecheck.is_int(maxMemoryPerScript, AssertionError)
        ...
        self.maxMemoryPerScript = maxMemoryPerScript
    ...
    def decode(cls, json, agent):
        obj = cls(
            maxMemoryPerScript = json['maxMemoryPerScript'],
    ...
    def encode(self):
        json = {}
        json['maxMemoryPerScript'] = self.maxMemoryPerScript
...
class Manager(Interface):
    idlType = "luaservice.Manager:1.0.0"
    ...
    class _getScriptOutput(Interface.Method):
        ...
        def decode(rsp, agent):
            _ret_ = rsp['_ret_']
            oAddr = long(rsp['oAddr'])
            nAddr = long(rsp['nAddr'])
            oString = rsp['oString']
            more = rsp['more']
            typecheck.is_int(_ret_, DecodeException)
