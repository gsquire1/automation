...
#
# Section generated from "/home/nb/builds/MEGA/px2-3.2.30-3.2.39-branch-20160511-none-release-none-pdu-raritan/fwcomponents/mkdist/tmp/px2_final/libidl_client/topofw/ports/idl/Port.idl"
#
...
class Port(Interface):
    ...
    class DetectionType(Enumeration):
        idlType = "portsmodel.Port_2_0_1.DetectionType:1.0.0"
    ...
    class DetectionMode(Structure):
        idlType = "portsmodel.Port_2_0_1.DetectionMode:1.0.0"
    ...
    class Properties(Structure):
        idlType = "portsmodel.Port_2_0_1.Properties:1.0.0"
    ...
    class PropertiesChangedEvent(raritan.rpc.idl.Event):
        idlType = "portsmodel.Port_2_0_1.PropertiesChangedEvent:1.0.0"
    ...
    class DeviceChangedEvent(raritan.rpc.idl.Event):
        idlType = "portsmodel.Port_2_0_1.DeviceChangedEvent:1.0.0"
